...
- [ ]  Hit `/` to see all the types of content you can add - headers, videos, sub pages, etc.
    ...
    [Example sub page](https://www.notion.so/Example-sub-page-066d368525c84bdbb03bfc818096a8cb)
...
- This is a toggle block. Click the little triangle to see more useful tips!
    ...
    - Stay organized with your sidebar and nested pages:
        ...
        ![Getting%20Started%200005b5d2a8a347a2aff1bed8376160d5/infinitehierarchynodither.gif](Getting%20Started%200005b5d2a8a347a2aff1bed8376160d5/infinitehierarchynodither.gif)
